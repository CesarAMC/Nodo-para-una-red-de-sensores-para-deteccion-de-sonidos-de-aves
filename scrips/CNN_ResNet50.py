...
# Guardar modelo
model.save("modelo_CNNaves_ResNet50.keras")

# Resumen del modelo
model.summary()

# Visualización gráfica del modelo
plot_model(model, to_file='modelo_architecture_ResNet50.png', show_shapes=True, show_layer_names=True)
...
def plot_training_history(history):
    ...
    plt.savefig("grafica_entrenamiento_ResNet50.png", dpi=300, bbox_inches='tight')
